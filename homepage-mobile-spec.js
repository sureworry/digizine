...
var MOBILE_HOMEPAGE_LAYOUT_SPEC = {
  ...
  'idea-marinade': { x: 7, y: 1009, width: 248, height: 272 },
  observations: { x: 2, y: 1348, width: 336, height: 239 },
  'self-perception': { x: 30, y: 1625, width: 220, height: 227 },
  about: { x: 32, y: 1980, width: 238, height: 390 },
  books: { x: 228, y: 1186, width: 81, height: 95 },
  plant: { x: 201, y: 1757, width: 147, height: 183 },
  /* Mobile: coffee replaces chinese-cat (hidden via CSS). Height from desktop 152×112 aspect at 100px wide. */
  coffee: { x: 257, y: 2301, width: 100, height: 74 }
};
